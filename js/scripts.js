...
$('.storyTeller').shuffle();
    ...
    $('.storyTeller').hover(function() {
var heighter = ($(this).find(".member_img img").height());
      $(this).find('.whiteBlock').stop().animate({height:'250px'},300, function(){
      $(this).find('.icon').stop().animate({opacity:1},300);
      });
      },
      function() {
      $(this).find('.icon').stop().animate({opacity:0},300);
      $(this).find('.whiteBlock').stop().animate({height:'0px'},600);
    });
